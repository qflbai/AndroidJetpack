...
public class NetBaseUrl {
     ...
     * 主机地址
     */
    private static final String URL_IP = "www.baidu.com/";

    /**
     * debug模式主机地址
     */
    private static final String DEBUG_URL_IP = "http://192.168.8.102:8080/tang-erp/";

    /**
     * 主机名
     */
    private static final String URL_HOSTNAME = URL_IP;
    /**
     * debug模式下主机名
     */

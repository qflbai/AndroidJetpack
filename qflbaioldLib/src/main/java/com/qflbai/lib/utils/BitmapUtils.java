...
public class BitmapUtils {
    //生成二维码图片（不带图片）
    public static Bitmap createQRCode(String contents, int widthAndHeight) {
        ...
        try {
            ...
            BitMatrix matrix = multiFormatWriter.encode(contents, BarcodeFormat.QR_CODE, widthAndHeight, widthAndHeight);

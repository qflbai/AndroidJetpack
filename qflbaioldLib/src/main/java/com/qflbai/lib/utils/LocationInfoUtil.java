...
public class LocationInfoUtil {
     ...
     * 半径
     */
    public static final String KEY_RADIUS = "key_latitude";
    /**
     * 国家代号
     */
    ...
    private static HashMap<String, String> getInfo(Context context) {
        ...
        lontitude = preferences.getString(KEY_LONTITUDE, "");
        ...
        map.put(KEY_LONTITUDE, lontitude);
     ...
     * @Description: 保存定位信息
     */
    public static void savaLAddress(Context context, String latitude, String lontitude, String radius,
                                    String countryCode,
        ...
        /**经度******/
        if (lontitude != null) {
            editor.putString(KEY_LONTITUDE, lontitude);
        }
        /**半径********/
        if (radius != null) {

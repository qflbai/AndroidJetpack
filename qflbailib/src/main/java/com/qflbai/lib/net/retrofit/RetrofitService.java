...
public interface RetrofitService {
    ...
    @Streaming
    @GET
    Observable<Response<ResponseBody>> download(@Url String urlPath);
    @Streaming
    @GET
    ...
    @Multipart
    @POST
    Observable<Response<ResponseBody>> uplodaOne(@Url String urlPath, @QueryMap Map<String, Object> paramMap, @Part MultipartBody.Part file);
}

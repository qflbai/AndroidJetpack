...
/**
 * Utility functions around com.camera settings.
 */
public class SettingsUtil {
    ...
    public static class SelectedPictureSizes {
         ...
         * returns the com.camera size it represents. <br/>
         ...
         * @param supportedSizes all possible com.camera sizes that are supported
    ...
    /**
     * Determines the video quality for large/medium/small for the given com.camera.
     ...
     * @param cameraId The ID of the com.camera for which to get the quality
     *            setting.
    ...
    /**
     * Gets the first (lowest-indexed) com.camera matching the given criterion.
     *
     ...
     * @return The ID of the first com.camera matching the supplied criterion, or
     *         -1, if no com.camera meeting the specification was found.
     */
    ...
    public static interface CameraDeviceSelector {
        /**
         * Given the static characteristics of a specific com.camera device, decide whether it is the
         * one we will use.
         *

...
public class AppUpgrader extends SettingsUpgrader {
    ...
    /**
     * With this version, the com.camera size setting changed from a "small",
    ...
    /**
     * With this version, the names of the files storing com.camera specific and
    ...
    private void upgradeTypesToStrings(SettingsManager settingsManager) {
        ...
        // Last com.camera used module index: Integer -> String, from default.
        ...
        // Flash supported back com.camera setting: boolean -> String, from old
        // global.
    ...
    private void upgradeCameraSizeSetting(SettingsManager settingsManager,
        ...
        if (facing == SettingsUtil.CAMERA_FACING_FRONT) {
            ...
            Log.w(TAG, "Ignoring attempt to upgrade size of unhandled com.camera facing direction");
            return;
        }

        // infos might be null if the underlying com.camera device is broken. In
     ...
     * old com.camera SharedPreferences files to new files.
     */

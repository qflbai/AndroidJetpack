...
public class Keys {
    ...
    public static final String KEY_STARTUP_MODULE_INDEX = "com.camera.startup_module";
    ...
    public static void setDefaults(SettingsManager settingsManager, Context context) {
        ...
        // |CamcorderProfile.hasProfile| needs com.camera id info. We need a way to provide com.camera id to
    ...
    /**
     * Returns whether the com.camera has been set to back facing in settings.
     */

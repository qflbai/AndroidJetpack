...
import com.camera.app.CameraApp;
...
public class ProcessingService extends Service implements CaptureSession.ProgressListener {
    ...
    public static final String ACTION_PAUSE_PROCESSING_SERVICE =
            "com.android.com.camera.processing.PAUSE";
    /**
    ...
    public static final String ACTION_RESUME_PROCESSING_SERVICE =
            "com.android.com.camera.processing.RESUME";
    ...
    /**
     * Returns the common com.camera services.
     */

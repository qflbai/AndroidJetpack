...
import com.camera.filmstrip.ImageData;
...
public class CameraUtil {
    ...
    public static com.qfl.camera2.portability.Size getOptimalPreviewSize(Context context,
            List<com.qfl.camera2.portability.Size> sizes, double targetRatio) {
     ...
     */
    public static com.qfl.camera2.portability.Size getOptimalVideoSnapshotPictureSize(
            List<com.qfl.camera2.portability.Size> sizes, int targetWidth,
            int targetHeight) {
        ...
        com.qfl.camera2.portability.Size optimalSize = null;

        //  WYSIWYG Override
        //  We assume that physical display constraints have already been
        //  imposed on the variables sizes
        for (com.qfl.camera2.portability.Size size : sizes) {

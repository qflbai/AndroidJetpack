...
/**
 * This class tracks the timing of important state changes in com.camera app (e.g latency
 * of cold/warm start of the activity, mode switch duration, etc). We can then query
 * these values from the instrument tests, which will be helpful for tracking com.camera

...
public abstract class CameraModule implements ModuleController {
    ...
    /**
     * @return An instance used by the module to get the com.camera.
     */
    ...
    /**
     * Requests the back com.camera through {@link CameraProvider}.
     * This calls {@link
     * com.android.camera.app.CameraProvider#requestCamera(int)}. The com.camera
     * will be returned through {@link
     * #onCameraAvailable(com.android.ex.camera2.portability.CameraAgent.CameraProxy)}
     * when it's available. This is a no-op when there's no back com.camera
     * available.
     */
    ...
    /**
     * Releases the back com.camera through {@link CameraProvider}.
     * This calls {@link
     * com.android.camera.app.CameraProvider#releaseCamera(int)}.
     * This is a no-op when there's no back com.camera available.
     */

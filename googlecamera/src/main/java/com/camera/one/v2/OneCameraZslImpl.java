...
import com.camera.CaptureModuleUtil;
...
import com.camera.one.AbstractOneCamera;
...
import com.camera.util.ConjunctionListenerMux;
import com.camera.util.JpegUtilNative;
...
public class OneCameraZslImpl extends AbstractOneCamera {
    ...
    /**
     * Thread on which high-priority com.camera operations, such as grabbing preview
    ...
    /** Thread on which low-priority com.camera listeners are running. */
    private final HandlerThread mCameraListenerThread;
    private final Handler mCameraListenerHandler;

    /** The characteristics of this com.camera. */
    private final CameraCharacteristics mCharacteristics;
    /** The underlying Camera2 API com.camera device. */
    private final CameraDevice mDevice;

    /**
     * The aspect ratio (width/height) of the full resolution for this com.camera.
     * Usually the native aspect ratio of this com.camera.
     */
    ...
    /**
     * Instantiates a new com.camera based on Camera 2 API.
     *
    ...
    public void takePicture(final PhotoCaptureParameters params, final CaptureSession session) {
        ...
        if (useZSL) {
            ...
            if (capturedPreviousFrame) {
                ...
                if (params.flashMode == PhotoCaptureParameters.Flash.ON || params.flashMode == PhotoCaptureParameters.Flash.AUTO) {
    ...
    private void addFlashToCaptureRequestBuilder(CaptureRequest.Builder builder, PhotoCaptureParameters.Flash flashMode) {
        switch (flashMode) {
            case ON:
    ...
    private boolean sendAutoExposureTriggerRequest(PhotoCaptureParameters.Flash flashMode) {
     ...
     *
     * @param characteristics the characteristics of the com.camera device.

...
public class OneCameraManagerImpl extends OneCameraManager {
    ...
    @Override
    public void open(OneCamera.Facing facing, final boolean useHdr, final Size pictureSize,
                     final OneCamera.OpenCallback openCallback, Handler handler) {
        try {
    ...
    public boolean hasCameraFacing(OneCamera.Facing facing) {
        return getFirstCameraFacing(facing == OneCamera.Facing.FRONT ? CameraCharacteristics.LENS_FACING_FRONT

...
public interface FilmstripController {
    ...
    /**
     * @return Whether the current view in filmstrip is com.camera preview.
     */
    ...
    /**
     * Scales down to filmstrip mode. If the current item is com.camera preview,

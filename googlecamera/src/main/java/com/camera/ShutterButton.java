...
public class ShutterButton extends ImageView {
    ...
    protected void drawableStateChanged() {
        ...
        if (pressed != mOldPressed) {
            if (!pressed) {
                // When pressing the physical com.camera button the sequence of
                // events is:
                //    focus pressed, optional com.camera pressed, focus released.
                ...
                // Since we're emulating the physical com.camera button, we want to

...
import com.camera.AnimationManager;
import com.camera.ButtonManager;
import com.camera.CaptureLayoutHelper;
import com.camera.ShutterButton;
import com.camera.TextureViewHelper;
...
import com.camera.ui.BottomBar;
import com.camera.ui.BottomBarModeOptionsWrapper;
import com.camera.ui.CaptureAnimationOverlay;
import com.camera.ui.GridLines;
import com.camera.ui.MainActivityLayout;
import com.camera.ui.ModeListView;
import com.camera.ui.ModeTransitionView;
import com.camera.ui.PreviewOverlay;
...
import com.camera.util.Gusterpolator;
import com.camera.util.PhotoSphereHelper;
import com.camera.widget.Cling;
import com.camera.widget.FilmstripLayout;
import com.camera.widget.IndicatorIconController;
import com.camera.widget.ModeOptionsOverlay;
import com.camera.widget.PeekView;
...
public class CameraAppUI implements ModeListView.ModeSwitchListener,
    ...
    public static class BottomBarUISpec {
        ...
        /**
         * Set true if the com.camera option should be enabled.
         * If not set or false, and multiple cameras are supported,
         * the com.camera option will be disabled.
         *
         * If multiple cameras are not supported, this preference
         * is ignored and the com.camera option will not be visible.
         */
        public boolean enableCamera;

        /**
         * Set true if the com.camera option should not be visible, regardless
         ...
         * that will be executed when the com.camera option is pressed. This
     ...
     * top of preview until preview is ready (i.e. com.camera preview is started and
     ...
     * specific changes that depend on the com.camera or com.camera settings.
     */
    ...
    public void prepareModuleUI() {
        ...
        mModeOptionsToggle = mCameraRootView.findViewById(R.id.accessibility_filmstrip_toggle_button);
    ...
    public void enableModeOptions() {
        /*
         * For modules using com.camera 1 api, this gets called in
         ...
         * switch modes
         *
         * For modules using com.camera 2 api, they're required to call this
    ...
    /**
     * Sets the pressed color of the bottom bar for a com.camera mode index.
     */
    ...
    public void applyModuleSpecs(final HardwareSpec hardwareSpec,
        ...
        if (mController.getCameraProvider().getNumberOfCameras() > 1 &&
            ...
            // Hide com.camera icon if front com.camera not available.
        ...
        if (bottomBarSpec.hideFlash || !flashBackCamera) {
            ...
            if (hardwareSpec.isFlashSupported()) {
                ...
                // by the chosen com.camera hardware.
                buttonManager.disableButton(ButtonManager.BUTTON_FLASH);
                buttonManager.disableButton(ButtonManager.BUTTON_TORCH);
            }
        }

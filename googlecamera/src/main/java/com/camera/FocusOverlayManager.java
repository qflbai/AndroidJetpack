 ...
 *
 * The test cases:
 * (1) The com.camera has continuous autofocus. Move the com.camera. Take a picture when
 *     CAF is not in progress.
 * (2) The com.camera has continuous autofocus. Move the com.camera. Take a picture when
 *     CAF is in progress.
 * (3) The com.camera has face detection. Point the com.camera at some faces. Hold the
 *     shutter. Release to take a picture.
 * (4) The com.camera has face detection. Point the com.camera at some faces. Single tap
 *     the shutter to take a picture.
 * (5) The com.camera has autofocus. Single tap the shutter to take a picture.
 * (6) The com.camera has autofocus. Hold the shutter. Release to take a picture.
 * (7) The com.camera has no autofocus. Single tap the shutter and take a picture.
 * (8) The com.camera has autofocus and supports focus area. Touch the screen to
 *     trigger autofocus. Take a picture.
 * (9) The com.camera has autofocus and supports focus area. Touch the screen to
 *     trigger autofocus. Wait until it times out.
 * (10) The com.camera has no autofocus and supports metering area. Touch the screen
...
public class FocusOverlayManager implements PreviewStatusListener.PreviewAreaChangedListener,
    ...
    // Focus is in progress and the com.camera should take a picture after focus finishes.
    ...
    private boolean mMirror; // true if the com.camera is front-facing.
    ...
    public void updateCapabilities(CameraCapabilities capabilities) {
        ...
        // before com.camera is open. We will just return in this case, because
    ...
    public void onAutoFocusMoving(boolean moving) {
        ...
        // Ignore if the com.camera has detected some faces.
        if (mUI.hasFaces()) {
            mUI.clearFocus();
            return;
        }
    ...
    public CameraCapabilities.FocusMode getFocusMode(
        ...
        if (mFocusAreaSupported && mFocusArea != null) {
            ...
            String focusSetting = mSettingsManager.getString(mAppController.getCameraScope(),
                    Keys.KEY_FOCUS_MODE);
            Log.v(TAG, "stored focus setting for com.camera: " + focusSetting);
    ...
    public void resetTouchFocus() {
        ...
        // getMeteringAreas() and send updated regions to com.camera.
        mListener.setFocusParameters();

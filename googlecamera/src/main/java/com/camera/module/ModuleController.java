...
public interface ModuleController extends ShutterButton.OnShutterButtonListener {
     ...
     *
     * @param activity The com.camera activity.
     * @param isSecureCamera Whether the app is in secure com.camera mode.
    ...
    /**
     * Called by the app when the com.camera is available. The module should use
     * {@link com.android.camera.app.AppController#}
     *
     * @param cameraProxy The com.camera device proxy.
     */
     ...
     * based on the module's open com.camera device.
     */

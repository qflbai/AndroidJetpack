 ...
 * data from jpeg file. Note that only   can be rotated.
 */
public class RotationTask extends AsyncTask<LocalData, Void, LocalData> {
    ...
    private LocalData rotateInJpegExif(LocalData data) {
        ...
        LocalMediaData.PhotoData result = null;
        if (success) {
            ...
            result = new LocalMediaData.PhotoData(data.getContentId(), data.getTitle(),

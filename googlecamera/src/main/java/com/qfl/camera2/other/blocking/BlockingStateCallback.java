...
/**
 * A com.camera device listener that implements blocking operations on state changes.
 *
 ...
 * the last wait, or that will be received from the com.camera device in the
 * future.</p>
 *

 ...
 */
package com.qfl.camera2.other.pos;
...
import com.qfl.camera2.other.utils.SysTrace;
 ...
 * but automatic com.camera-caused AF state changes are broadcasted from any new result.</p>
 */
public class AutoFocusStateMachine {
    ...
    public interface AutoFocusStateListener {
        /**
         * The com.camera is currently focused (either active or passive).
         *
        ...
        /**
         * The com.camera is currently not focused (either active or passive).
         *
        ...
        /**
         * The com.camera is currently scanning (either active or passive)
        ...
        /**
         * The com.camera is currently not doing anything with the autofocus.
         *

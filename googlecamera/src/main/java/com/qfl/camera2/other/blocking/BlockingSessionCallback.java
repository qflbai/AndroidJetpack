...
import com.qfl.camera2.other.utils.StateChangeListener;
import com.qfl.camera2.other.utils.StateWaiter;
...
/**
 * A com.camera session listener that implements blocking operations on session state changes.
 *
...
public class BlockingSessionCallback extends CameraCaptureSession.StateCallback {
    ...
    /**
     * Wait until the designated surface is prepared by the com.camera capture session.
     *

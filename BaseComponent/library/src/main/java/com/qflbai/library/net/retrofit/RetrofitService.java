package com.qflbai.library.net.retrofit;
...
public interface RetrofitService {
    ...
    @POST
    @Headers("Content-Type: application/json")
    Observable<Response<ResponseBody>> postJsonNet(@Url String urlPath, @HeaderMap Map<String, String> headerMap, @Body Object param);

package com.qflbai.library.net.clinet;


import com.qflbai.library.net.interceptor.DownloadInterceptor;
import com.qflbai.library.net.interceptor.LogInterceptor;
import com.qflbai.library.net.interceptor.TokenHeaderInterceptor;
...
public class NetClinet {
     ...
     * 网络连接超时时间
     */
    private static final long CONNECT_TIME_OUT = 3;
    /**
     * 网络写入时间
     */
